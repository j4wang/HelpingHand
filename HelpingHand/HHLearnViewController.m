...
@interface HHLearnViewController ()

@end

@implementation HHLearnViewController {
    UIView *_view;
    UIButton *_jobButton;
    UIButton *_degButton;
...
- (id)init
{
    ...
    if (self) {
        ...
        whatLearnLabel.text = @"What do you \n want to learn?";
        ...
        [jobButton setTitle:@"Finance" forState:UIControlStateNormal];
        ...
        [busButton setTitle:@"Education" forState:UIControlStateNormal];
        ...
        [degButton setTitle:@"Technology" forState:UIControlStateNormal];
        ...
        [learnButton setTitle:@"Health" forState:UIControlStateNormal];
